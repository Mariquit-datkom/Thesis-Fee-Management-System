...
<table style="border: 1px solid black; width: 100%; max-width: 800px; border-collapse: collapse; font-family: Arial, sans-serif;">
    ...
    <tr>
        ...
        <td style="border-bottom: 1px solid black; padding: 10px; width: 50%;">
            <span class="bold">Date:</span> <?php echo htmlspecialchars($date); ?>
        </td>
    </tr>

    <tr>
        <td colspan="2" style="border-bottom: 1px solid black; padding: 10px;">
            <span class="bold">Reference Number:</span> #<?php echo htmlspecialchars($referenceNumber); ?>
        </td>
    </tr>

    <tr>
        <th class="center" style="border-right: 1px solid black; border-bottom: 1px solid black; padding: 10px;">Payment for:</th>
